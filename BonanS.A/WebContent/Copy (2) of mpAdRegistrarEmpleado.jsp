...
<html>
	<head>
        ...
        <script language="javascript" type="text/javascript" src="js/mylibs/tablaDirecciones.js"></script>
        <script language="javascript" type="text/javascript" src="js/mylibs/ubigeo.js"></script>
                 ...
                 <h3 class="block-title">Matenimiento de empleados</h3>
                  ...
                  <form action="">
                               ...
                               <div class="col-md-3 m-b-15">
		                            ...
		                            <input type="text" id="txtIdCliente" name="txtIdCliente" class="input-sm form-control mask-phone" style="font-size: 16px;" placeholder="ingresar placa" required="requerid"
		                                    maxlength="20">
                               </div> 
		                        ...
		                        <label style="font-size: 12px;">Direccion</label>
		                            <input type="text" id="txtDireccion" name="txtDireccion" class="input-sm form-control mask-phone" style="font-size: 16px;" placeholder="ingresar marca" required="requerid">
		                        </div>
                                  
                                  
                                <div class="col-md-3 m-b-15">
		                            <label style="font-size: 12px;">Ubigeo</label>
		                            <input type="text" id="txtIdUbigeo" name="txtIdUbigeo" class="input-sm form-control mask-phone" style="font-size: 16px;" placeholder="ingresar marca" required="requerid">
                               </div>  
                               
                               <div class="col-md-3 m-b-15">
		                            <label style="font-size: 12px;">Tipo Establecimiento</label>
		                            <select id="cboTipo">
		                            <option value="H">Hola</option>
		                            <option value="C">Chau</option>
		                            </select>
                               </div>
                               ...
                               <div class="col-md-3 m-b-15">
                               <label style="font-size: 12px;" for="cboPronvincia">Pronvincia</label>
                                 <select id="cboPronvincia" name="cboPronvincia" ></select>
                               </div>  
                               
                               <div class="block-area" >
                               <input type="button" id="registrarDireccion" name="registrarDireccion" value="Agregar" onclick="fn_agregar()">
