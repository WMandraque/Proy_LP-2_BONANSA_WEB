...
<!-- 				    <li class="subitem2"><a href="#">Actualizar GRT</a></li>
     ...
     <div class="block-area" id="required">
       ...
       <form action="gestionaIncidencia" method="post">
         ...
         <legend class="block-title" style="color: white;">Listado de Incidencias</legend>
													...
													<c:forEach var="lista" items="${sessionScope.s_listadoIncidencias}">
															...
															<td class="center">
																<div class="visible-md visible-lg hidden-sm hidden-xs">
																	<div class="btn-group">
																		<a class="btn btn-primary dropdown-toggle btn-sm" data-toggle="dropdown" onclick="location='paActualizarIncidencias.jsp?idIncidencia=${lista.idIncidencia}&idEmpleado=${lista.idEmpleado}&direccion=${lista.direccion}&descripcion=${lista.descripcion}&fecha=${lista.fecha}&hora=${lista.hora}&idEstadoIncidencia=${lista.idEstadoIncidencia}'">
