																...
																<div class="visible-md visible-lg hidden-sm hidden-xs">
																	<div class="btn-group">
																		...
																		<ul role="menu" class="dropdown-menu pull-right">
																			...
																			<li role="presentation">
																				<a role="menuitem" tabindex="-1" href="paRegistrarSolicitudRecojo.jsp?idEmpleado=${lista.idEmpleado}&nombreCompletoEmp=${lista.nomEmpleado} ${lista.apepaEmpleado} ${lista.apemaEmpleado}&tipoEmpleado=${lista.nomCargo}">
																					 Registrar en SOR
																				</a>
																			</li>
