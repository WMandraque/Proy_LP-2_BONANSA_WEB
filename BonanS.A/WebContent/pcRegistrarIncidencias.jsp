...
<%-- 					 <li class="subitem1"><a href="gestionaOrdenRecojo?operacion=listar&idEmpleado=${sessionScope.idEmpleado}&nivel=condu">Mis Ordenes de recojo</a></li>
 --%>				     <%-- <li class="subitem1"><a href="gestionaGRT?operacion=listar&nivel=CONDUCTOR&idEmpleado=${sessionScope.idEmpleado}">Listar GRT</a></li> --%>
	...
	<div class="block-area" id="required">
		...
		<!--Titulo  -->
		<h3 class="block-title">Control de Ruta</h3>
	</div>
					...
					<div class="block-area">
		             ...
		             <div class="row">
		                        ...
		                        <input type="text" id="txtIdEmpleado" name="txtIdEmpleado"  class="input-sm form-control mask-phone" 
		                               style="font-size: 16px;text-align: center;" value="${sessionScope.idEmpleado}" readonly="readonly">
		                        </div>
		                        ...
		                        <input type="text"  class="input-sm form-control mask-phone" 
		                               style="font-size: 16px;text-align: center;" value="FECHA CAPTURADA" readonly="readonly">
		                        </div>
		                        
		                        <div class="col-md-3 m-b-15">
		                        <label style="font-size: 12px;">HORA</label>
		                        <input type="text" name="txtClave" class="input-sm form-control mask-phone" 
		                               style="font-size: 16px;text-align: center;" value="HORA CAPTURADA" readonly="readonly">
		                        </div>
		             ...
		             <div class="row">
		                        ...
		                        <textarea id="txtDescripcion" name="txtDescripcion" class="input-sm form-control mask-phone" 
		                               style="font-size: 16px;"  required="requerid" maxlength="300"  rows="3" cols="40"></textarea>
		                        </div>
