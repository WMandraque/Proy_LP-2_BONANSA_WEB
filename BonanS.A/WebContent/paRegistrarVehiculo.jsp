...
<body id="skin-blur-sunset">
				...
				<ul>
					...
					<li class="subitem3"><a
        				...
        				<li class="item4"><a href="#">Mantenimiento Vehiculos</a>
                         ...
                         <li class="item4"><a href="#">Registro de acciones</a>						    <ul>
     ...
     <div class="block-area" id="required">
       ...
       <legend class="block-title" style="color: white;">Registrar vehiculo</legend>
                   
       <div class="block-area"> 
        


	<div class="block-area" ><!--Contenedor de datos generales  -->
		          ...
		          <div class="row">
		                 ...
		                 <div class="col-md-3 m-b-29">
		                        ...
		                        <label style="font-size: 12px;">Categoria del Vehiculo</label>
		                           <libreria:cboCategoriaVehiculo idCatVeh="0"/>
		                        </div>
