         ...
         <legend class="block-title" style="color: white;">Listado de GRT</legend>
                  ...
                  <div class="col-md-12">
												...
												<table class="table table-bordered table-hover tile" id="sample_1" style="table-layout:auto;font-size:12px;">
													...
													<c:forEach var="lista" items="${sessionScope.s_listadoGRT}">
                  
														                  <tr>
														                  <td>${lista.idGRT}</td>
														                  <td>${lista.idEmpleado}</td>
														                  <td>${lista.licenCondEmpleado}</td>
														                  <td>${lista.idVeh}</td>
														                  <td>${lista.placaVeh}</td>
														                  <td>${lista.idCliRemitente}</td>
														                  <td>${lista.nomCliRemitente} ${lista.apePaCliRemitente} ${lista.apeMaCliRemitente}</td>
														                  <td>${lista.direcCliRemitente}</td>
														                  <td>${lista.nomCliDestinatario} ${lista.apepaCliDestinatario} ${lista.apemaCliDestinatario}</td>
														                  <td>${lista.direcClienteDestinatario}</td>
														                  <td>${lista.fecMinEntrega}</td>
														                  <td>${lista.fecMaxEntrega}</td>
														                  <td>${lista.descEstadoGRT}</td>
