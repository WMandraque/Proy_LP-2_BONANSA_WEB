        ...
        <section id="content" class="container">
                <div id="messages" class="tile drawer animated">
                    <div class="listview narrow">
                        <div class="media">
                            <a href="">Enviar un Nuevo Mensaje</a>
                ...
                <div class="block-area shortcut-area">
                    ...
                    <a class="shortcut tile" href="">
                        ...
                        <small class="t-overflow">Conexion</small>
                    </a>
                    <a class="shortcut tile" href="paLog.jsp">
                            ...
                            <div class="tile text-center">
                                <div class="tile-dark p-10">
                                    <div class="pie-chart-tiny" data-percent="86">
                                        ...
                                        <span class="pie-title">Nuevos Visitantes <i class="m-l-5 fa fa-retweet"></i></span>
                                    </div>
                                    ...
                                    <div class="pie-chart-tiny" data-percent="57">
                                        <span class="percent"></span>
                                        <span class="pie-title">Correos Enviados <i class="m-l-5 fa fa-retweet"></i></span>
                                    </div>
                                    <div class="pie-chart-tiny" data-percent="34">
                                        <span class="percent"></span>
                                        <span class="pie-title">Estado de Ventas <i class="m-l-5 fa fa-retweet"></i></span>
                                    </div>
