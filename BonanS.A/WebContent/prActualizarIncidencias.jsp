...
<!-- 				<li class="subitem3"><a href="gestionaOrdenRecojo?operacion=listarClientes">Listar Clientes</a></li>
	...
	<div class="block-area" id="required">
		...
		<form action="gestionaIncidencia" method="post">
			...
			<input type="hidden" name="nivel" value="RECEPCIONISTA">
				...
				<legend class="block-title" style="color: white;">Actualizar Incidencia</legend>
					...
					<div class="block-area">
		                   	  ...
		                   	  <div class="col-md-3 m-b-15">
		                   		...
		                   		<div class="col-md-3 m-b-15">
                                   <br>
		                           <input type="button" class="btn" value="Buscar Incidencia" onclick="location='gestionaIncidencia?operacion=listar&nivel=RECEPCIONISTA'">
		                        </div>
		            </div>
