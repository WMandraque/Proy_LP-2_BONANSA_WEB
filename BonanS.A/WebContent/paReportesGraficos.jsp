...
<script language="javascript" type="text/javascript" src="js/mylibs/paReportesGraficos.js"></script>
...
<h4 class="tile-title">Menu de Opciones</h4><br><br>
	...
	<div class="block-area" id="required">
		...
		<!--Titulo  -->
		<h3 class="block-title">REPORTES</h3>
	</div>
	...
	<div class="block-area" id="required">
		...
		<fieldset>
		            ...
		            <legend class="block-title" style="color: white;">Reportes Graficos</legend>
				
				     <div class="col-md-3 m-b-15">
									<select class="select" id="cboEntidadReporte" name="cboEntidadReporte">
									            <option value="0">Seleccione</option>
												<option value="1">Reporte Cliente</option>
												<option value="2">Reportes Empleados</option>
												<option value="3">Reportes Vehiculos</option>
												<option value="4">Reportes Orden Recojo</option>
												<option value="5">Reportes GRT</option>
												<option value="6">Reportes Incidencias</option>
									</select>
					</div>
						...
						<div class="row">
										 <div class="col-md-3 m-b-15">											
											<select name="operacion" id="tipo" onchange="verGraficoReporteCliente()" class="select">
												<option value="">Seleccione</option>
												<option value="1">Clientes Registrados en 2015</option>
												<option value="2">Clientes Eliminados en 2015</option>
												<option value="3">Tipos de Cliente</option>
							
											</select>
											</div>
											<p align="center"> <img src="" id="grafico" ></p>
						...
						<div class="row">
										 <div class="col-md-3 m-b-15">											
											<select name="operacion" id="cboReporteEmpleado" onchange="verGraficoReporteEmpleado()" class="select">
												<option value="">Seleccione</option>
						                        <option value="1">Empleados Registrados en 2015</option>
												<option value="2">Empleado Eliminados en 2015</option>
												<option value="3">Tipos de Empleados</option>
											</select>
											</div>
											<p align="center"> <img src="" id="graficoEmpleado" ></p>
						...
						<div class="row">
										 <div class="col-md-3 m-b-15">											
											<select name="operacion" id="cboReporteVehiculo" onchange="verGraficoReporteVehiculo()" class="select">
												<option value="">Seleccione</option>
												<option value="1">Vehiculo Registrados en 2015</option>
												<option value="2">Vehiculo Eliminados en 2015</option>
												<option value="3">Categorias de Vehiculo</option>
							
											</select>
											</div>
											<p align="center"> <img src="" id="graficoVehiculo" ></p>
						...
						<div class="row">
										 <div class="col-md-3 m-b-15">											
											<select name="operacion" id="cboReporteSOR" onchange="verGraficoReporteSOR()" class="select">
												<option value="">Seleccione</option>
											...
											<p align="center"> <img src="" id="graficoSOR" ></p>
						...
						<div class="row">
										 <div class="col-md-3 m-b-15">											
											<select name="operacion" id="cboReporteGRT" onchange="verGraficoReporteGRT()" class="select">
												<option value="">Seleccione</option>
												<option value="1">GRT Registrados en 2015</option>
												<option value="2">GRT por Estado</option>							
											</select>
											</div>
											<p align="center"> <img src="" id="graficoGRT" ></p>
						...
						<div class="row">
										 <div class="col-md-3 m-b-15">											
											<select name="operacion" id="cboReporteIncidencia" onchange="verGraficoReporteIncidencia()" class="select">
												<option value="">Seleccione</option>
												<option value="1">GRT Registrados en 2015</option>
												<option value="2">GRT por Estado</option>							
											</select>
											</div>
											<p align="center"> <img src="" id="graficoIncidencia" ></p>
