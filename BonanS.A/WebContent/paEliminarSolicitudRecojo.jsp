...
<title>Actualizar Solicitud de Recojo</title>
		...
		<nav id="wrapper">
		   ...
		   <ul class="menu">
			...
			<a href="mpAdministrador.jsp"><img width="25" src="img/icon/home.png"> Inicio</a><br><br>
			 ...
			 <li class="nivel1 s-widget m-b-25"><a href="#"><img width="20" src="img/icon/form.png"> Gestion de Recojo</a>
			...
			<li class="nivel1 s-widget m-b-25"><a href="#"><img width="25" src="img/icon/ui.png"> Gestion de Transporte</a>
			<ul class="main-menu mainmenu-menu">
<!-- 				    <li class="subitem2"><a href="#">Actualizar GRT</a></li>
			...
			<li class="nivel1 s-widget m-b-25"><a href="#"><img width="25" src="img/icon/chart.png"> Control de Ruta</a>
				<ul>
			...
			<li class="nivel1 s-widget m-b-25"><a href="#"><img width="25" src="img/icon/folder.png"> Mantenimiento Clientes</a>
			<ul class="main-menu mainmenu-menu">
			...
			<li class="nivel1 s-widget m-b-25"><a href="#"><img width="25" src="img/icon/pages.png"> Mantenimiento Empleados</a>
			<ul class="main-menu mainmenu-menu">
			...
			<li class="nivel1 s-widget m-b-25"><a href="#"><img width="25" src="img/icon/typography.png"> Mantenimiento Usuario</a>
			<ul class="main-menu mainmenu-menu">
			...
			<li class="nivel1 s-widget m-b-25"><a href="#"><img width="25" src="img/icon/photos.png"> Mantenimiento Vehiculos</a>
				<ul class="main-menu mainmenu-menu">
			...
			<li class="nivel1 s-widget m-b-25"><a href="#"><img width="25" src="img/icon/widgets.png"> Registro de acciones</a>
				<ul class="main-menu mainmenu-menu">
